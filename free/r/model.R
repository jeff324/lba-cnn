...
#setwd('C:/Users/Jeffrey/Dropbox/backup/Research Projects/mds_3M_v2/free_cat_sep_model/')
...
option_list = list(
     ...
     make_option(c('-c','--drift_correct'), type="numeric", default=1, 
     ...
     make_option(c('-i','--file_in'), type="character", default='data/same_different.RData', 
